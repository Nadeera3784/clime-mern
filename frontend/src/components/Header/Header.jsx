            ...
            <div className="flex justify-between container xl:max-w-7xl mx-auto px-4 lg:px-8">
                ...
                <div className="flex items-center space-x-2 lg:space-x-5">
                    <nav className="hidden lg:flex lg:items-center lg:space-x-1 lg:space-x-2">
                        ...
                        <a href="#" className="font-medium flex items-center space-x-2 px-4 py-2 rounded text-gray-500 hover:text-indigo-500 hover:bg-indigo-100 active:bg-transparent">
                        ...
                        <button onClick={(event) => onClickLogOut(event)} className="font-medium flex items-center space-x-2 px-4 py-2 rounded text-gray-500 hover:text-indigo-500 hover:bg-indigo-100 active:bg-transparent">
