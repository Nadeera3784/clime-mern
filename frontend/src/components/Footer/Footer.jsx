    ...
    return (
        <footer  className="flex flex-none items-center bg-white">
            ...
            <div className="pt-4 pb-1 md:pb-4">
                <a href="" target="_blank" className="font-medium text-indigo-600 hover:text-indigo-400">Clime</a> © 2020
            </div>
            <div className="pb-4 pt-1 md:pt-4 inline-flex items-center justify-center">
                ...
                <span>by <a href="" target="_blank" className="font-medium text-indigo-600 hover:text-indigo-400">Clime</a></span>
            </div>
            </div>
      </footer>
    )
